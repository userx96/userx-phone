...
$(".kilitEkraniContainer").click(function(){
  ...
  $(document).ready(function(){
   ...
   $(document).ready(function(){
    $(".resimSohbet1").click(function(){
     $(".buyukResimContainer").css({
       "background-image": "url(https://cdn.discordapp.com/emojis/697489502427414590.png?v=1)",
   ...
   $(document).ready(function(){
    $(".resimSohbet2").click(function(){
     $(".buyukResimContainer").css({
       "background-image": "url(https://cdn.discordapp.com/emojis/726115631514124339.png?v=1)",
       "background-repeat": "no-repeat",
       "background-position": "center"})
    });
   });
   ...
   $(document).ready(function(){
    $(".resimSohbet3").click(function(){
     $(".buyukResimContainer").css({
       "background-image": "url(https://cdn.discordapp.com/emojis/757477108975927346.png?v=1)",
       "background-repeat": "no-repeat",
       "background-position": "center"})
    });
   });
  
   $(".buyukResimContainer").click(function(){
    $(this).hide(500);
   });
